...
export function CreateEventModal({setShowModal, fetchEvents}: CreateEventModalProps){
    ...
    return <div className="z-999 absolute top-1/2 left-1/2 flex flex-col justify-between -translate-x-1/2 -translate-y-1/2  h-96 w-2xs 
            bg-white rounded-2xl shadow-xl shadow-gray-600 border-1 border-indigo-500 !p-2 ">
        <div>
            <button className="flex items-center justify-center p-3 bg-indigo-500 text-white rounded-full w-6 h-6 
            hover:bg-indigo-700 hover:cursor-pointer absolute top-2 right-2" 
