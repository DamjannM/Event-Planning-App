...
export function UpcomingEvents(){
  ...
  return <>
    {openModal ? <CreateEventModal setShowModal={setShowModal} fetchEvents={fetchEvents}/> : null}
    ...
    <div className="flex flex-col md:flex-row bg-transparent gap-2">
        ...
        <EventList events={events}  selectedMonth={selectedMonth} selectedYear={selectedYear} selectedDay={selectedDay} fetchEvents={fetchEvents}/>
    </div>
    </>
}